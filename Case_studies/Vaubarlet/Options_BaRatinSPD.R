...
# General options:
################################################################
name.folder.results.SPD  =  "G_L_b1_2"
...
isVar                    = c(T,F,F, T,F,F, F,F,F, F,F,F)        # [T/F] Define which RC parameters are varying (b1,a1,c1, b2,a2,c2, ...)
...
b.prior                  = c(0.04, 0.21, 1.85,2.25)                  # mean for parameters "b" for the oldest period 
st_b.prior               = c(0.035, 0.5, 0.2,0.2)             # stdev for parameters "b" for the oldest period
