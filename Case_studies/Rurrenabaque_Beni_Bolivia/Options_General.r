...
#***********************************************
official.shift.times = FALSE   #"Rurrenabaque_official_shift_times.csv"  # name of the csv file with official shift dates (put FALSE if not available!)
tOfficial.col        = 3                       # column position in the file ...
tOfficial.type       = "date"               # "numeric or "date".  
...
Bc.prior  = c(100, 200);           st_Bc.prior = c(20, 50)
...
b.prior  = c(-1.5, 4);    st_b.prior = c(1, 1)
