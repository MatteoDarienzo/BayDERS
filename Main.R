...
###############################################################################################
#                                                                                             #   
# Main author:   Matteo Darienzo                                                              #
# Institute:     INRAE Lyon-Grenoble, UR RiverLy, France                                      #
# Year:          2019                                                                         #
# version:       v.1.0.0  - last update: 04/09/2022                                           #
#                                                                                             #
#                                                                                             #
#---------------------------------------------------------------------------------------------#
...
#                            Mathieu Lucas (INRAE)                                            #
#                            Felipe Mendez (INRAE)                                            #
#                            Olga Parshina (Saint-Petersbourg University)                     #
#                                                                                             #
...
# Main references of BayDERS method:                                                          #
...
#---------------------------------------------------------------------------------------------#
# Make sure to have all following modules files located in the "Modules" subfolder:           # 
# - module_BaRatin.R                                                                          #
...
# developped by Benjamin Renard, git@github.com:BaM-tools/BaM.git) within the apposite        #
# "/BaM_exe" subfolder:                                                                       #
# - BaM_2exp_pool2.exe                                                                        #
# - BaM_BaRatin_2.exe                                                                         #
# - BaM_BaRatin_SPD.exe                                                                       #
...
#                                                                                             #
# ant the main configuration files "Config_BaM.txt" and the subfolders containing the         # 
...
# Get the main directory folder automatically:         
                   ...
                   pack = c("rstudioapi",
                     ...
                     "segclust2d",  "changepoint",  "minpack.lm", 
                     # "gganimate", "magick",   # packages to be used only for advanced analysis!   
                     #"patchwork", "egg",
