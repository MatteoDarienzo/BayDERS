...
#####################################
name.folder.results.recession = "chi30_tgood30"      # string with the name of the folder with results.
...
tgood                  = 25                                # min length of the recession in days
...
#
rec.model[[1]]                = c("2expWithAsympt_bis")       # Select stage-recession models (also more than one) (see the list at the bottom):
prior.param.rec[[1]]  = c(  0,                             1000,       "'Uniform'",     100,                      "var",
                            -log((0.5))+log(log(2)) ,      1,          "'LogNormal'",   exp(-log(0.5)+log(log(2))), "static",
...
#####################################
prior.mu.rec.segment           = c("Uniform", -50, 30, 0)        # c(distribution,  min or mean,  max or stdev, stanrting value)
gamma.prior.rec                = c("Uniform", 0, 8, 1)    #10       # c(distribution,  min or mean,  max or stdev,  starting value)
nSmax.rec                      = 5                                # Maximum number of change points that can be detected 
