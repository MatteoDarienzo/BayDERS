...
#########################################################################################################################
name.folder.results.recession = "Test_10"

#####################################
# 1) Recession extraction:
#####################################
uh.rec                 = 0                               # stdev of the stage obs error [in cm]
tburn.rec              = 0                               # discard the first n days of recession 
Nmin.rec               = 10                              # min number of data in a recession curve
tgood                  = 50                              # min length of the recession in days
delta.t.min            = 1                               # min days between two recess data
delta.t.max            = 50                              # max days between two recess data
chi                    = 250                             # max stage rise between two recess data
gradient.max           = -10
...
#####################################
prior.mu.rec.segment           = c("Uniform", -100, 150, 0)        # c(distribution,  min or mean,  max or stdev, stanrting value)
