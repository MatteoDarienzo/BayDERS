# General options:
################################################################
name.folder.results        = "mu1000_BIC_stb21_closestflood"
...
deltat_peaks               = 200                       # minimum time lag between major floods (to find all major peaks and adjust shift times), e.g., 100 or 1000 days
