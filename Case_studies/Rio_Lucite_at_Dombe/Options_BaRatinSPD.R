...
b.prior                  = c(0.536)                         # mean for parameters "b" for the oldest period 
st_b.prior               = c(0.5)                       # stdev for parameters "b" for the oldest period
...
ylim.log.wind            = grid_RC.ylim.log             # define Q limits for plots in log scale.
