...
#####################################
name.folder.results.recession = "shift150"      # string with the name of the folder with results.
...
rec.model[[2]]                = c("2expWithAsympt")           # Select stage-recession models (also more than one) (see the list at the bottom):
...
rec.model[[3]]                = c("2expWithAsympt_bis")       # Select stage-recession models (also more than one) (see the list at the bottom):
prior.param.rec[[3]]  = c(  0,                             1000,       "'Uniform'",     100,                      "var",
                            -log((0.5))+log(log(2)) ,      1,          "'LogNormal'",   exp(-log(0.5)+log(log(2))), "static",
...
rec.model[[4]]                = c("3expWithAsympt")                                                                          # Select stage-recession models (also more than one) (see the list at the bottom):
prior.param.rec[[4]]  =c( 0,                            1000,       "'Uniform'",      100,                      "var",       # prior: [in cm for param a and days-1 for param b]
...
rec.model[[5]]                = c("3expWithAsympt_bis")
...
prior.gamma.rec          = c(0, 100,   "'Uniform'", 10,     # Structural error prior gamma1 (intercept):  min or mean, max or stdev, distribution, starting value
                             0, 100,   "'Uniform'", 1)      # Structural error prior gamma2 (slope):  min or mean, max or stdev, distribution, starting value
Ncycles.mcmc.rec         = 100                            # number of mcmc cycles during the bayesian inference for recessions estimation
nmcmc.rec                = 50                            # number of mcmc per cycle
...
gamma.prior.rec                = c("Uniform", 0, 50, 1)           # c(distribution,  min or mean,  max or stdev,  starting value)
